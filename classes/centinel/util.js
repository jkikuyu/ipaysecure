...
function getStateSelectionHTML(name) {
    ...
    return "<select name=\"" + name + "\" style=\"width: 125px;\">" +
...
/**
 * Helper method to add an option to a select box
 */
function addOption(elementId, label, value) {
...
function setSelection(fieldName, index) {
    document.forms["frm"][field].selectedIndex = index;
}
